<footer class="main-footer">
  ...
  <strong>Copyright &copy; {{ Carbon\carbon::now()->year }} <a href="https://adminlte.io">Miceblog</a>.</strong> All rights
  reserved.
...
<script src="public/admin/bower_components/datatables.net-bs/js/jquery.dataTables.min.js"></script>
